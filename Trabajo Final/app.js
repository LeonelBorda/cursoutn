...
var bombachasRouter = require('./routes/bombachas');
var conjuntosRouter = require('./routes/conjuntos');
var deportivosRouter = require('./routes/deportivos');
...
app.use('/bombachas', bombachasRouter);
app.use('/conjuntos', conjuntosRouter);
app.use('/deportivos', deportivosRouter);
